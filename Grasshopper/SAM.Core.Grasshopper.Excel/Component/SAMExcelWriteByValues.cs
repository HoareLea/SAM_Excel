...
{
    public class SAMExcelWriteByValues : GH_SAMVariableOutputParameterComponent
    {
        /// <summary>
        ...
        /// </summary>
        public SAMExcelWriteByValues()
          : base("SAMExcel.WriteByValues", "SAMExcel.WriteByValues",
              "Write Microsoft Excel File by given array of values",
              "SAM", "Excel")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess dataAccess)
        {
            ...
            bool result = Core.Excel.Modify.Write(path, worksheetName, values, rowIndex, columnIndex, clearOption);
